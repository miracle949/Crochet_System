    ...
    <div class="ms-[250px] bg-[#fefefefe] relative mb-10">
        <div class="px-7 py-5">
            ...
            <div class="flex justify-between items-center mt-10">
                <div>
                    <h1 class="font-semibold"><i class="fa fa-tag"></i> Products</h1>
                </div>
                ...
                <div class="flex justify-between items-center gap-5">
                    ...
                    <a href="{{route("AddProducts")}}"
                        class="bg-[#212529] text-white rounded-[20px] py-2 px-4 text-[14.5px]">Add Products</a>
                </div>
            </div>
        </div>
            ...
            <div class="border-solid border-[1px] border-[rgba(0,0,0,0.3)] rounded-xl">
                <div class="p-3 border-b-[1px] border-solid border-[rgba(0,0,0,0.1)]">
                    <div class="flex gap-7 items-center">
                        ...
                        <p class="text-[14px]">Active</p>

                        <p class="text-[14px]">Draft</p>

                        <p class="text-[14px]">Product Condition</p>

                        <p class="text-[14px]">Archived</p>
                ...
                <table class="w-full">
                    <thead class="bg-[#F5F5F5]">
                        <tr class="text-[12px] border-solid border-b-[1px] border-[rgba(0,0,0,0.1)]">
                            ...
                            <th class="font-medium p-2 text-left">Featured</th>
                            <th class="font-medium p-2 text-left">Category</th>
                            <th class="font-medium p-2 text-left">Channels</th>
                            ...
                            @foreach ($products as $product)
                                <tr class="text-[12px] border-solid border-b-[1px] border-[rgba(0,0,0,0.1)] cursor-pointer">
                                    ...
                                    <td class="font-medium p-2">
                                        <button class="py-1.5 px-3 rounded-xl bg-green-300 text-black cursor-auto">
                                            Active
                                        </button>
                                    </td>
                                    <td class="font-medium p-2">
                                    ...
                                    <td class="font-medium p-2">{{ $product->category }}</td>
                                    <td class="font-medium p-2">2</td>
                                    <td class="font-medium p-2">
                                        ...
                                        <div class="flex gap-3">
                                            ...
                                            <a href="{{route('deleteProducts', $product->id)}}"
                                                class="py-1.5 px-3 border-solid border-[1px] border-[#212529] rounded-md">
