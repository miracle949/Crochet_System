...
<body>
    ...
    <div class="ms-[250px] bg-[#fefefefe] relative">
        ...
        <form action="{{route("SaveEditProducts")}}" method="post" enctype="multipart/form-data">
            ...
            <div class="flex justify-between items-center px-7 pt-1">
                ...
                <div>
                    <h2 class="text-[18px]"><i class="fa fa-store"></i> Update Products</h2>
                </div>
                ...
                <div class="flex justify-between m-7">
                    <div class="p-5 w-[55%] rounded-lg border-solid border-[1px] border-[rgba(0,0,0,0.3)]">
                        ...
                        <div class="mt-5">
                            ...
                            <input type="text" name="name" placeholder="Enter the product name" value="{{$product->name}}"
                        ...
                        <div class="mt-5">
                            ...
                            <select name="category" required
                                ...
                                <option value="{{$product->category}}" class="text-[14.5px]">{{$product->category}}</option>
                            </select>
                        </div>
                        ...
                        <div class="mt-5">
                            ...
                            <input type="text" name="stocks" placeholder="0.00" value="{{ $product->stocks }}"
                                class="w-full py-1.5 px-2 mt-2 rounded outline-0 text-[14.5px] border-solid border-[1px] border-[rgba(0,0,0,0.2)]"
                                required>
                        </div>

                        <div class="mt-5">
                            <label class="text-[15px]">Product Featured</label>
                            <select name="featured" required
                                class="w-full py-1.5 px-2 mt-2 outline-0 border-solid border-[1px] border-[rgba(0,0,0,0.2)] text-[14.5px]">
                                @if ($product->featured == "No")

                                <option value="{{ $product->featured }}" class="text-[14.5px]">{{ $product->featured }}</option>
                                <option value="Yes" class="text-[14.5px]">Yes</option>
                                
                                @elseif($product->featured == "Yes")

                                <option value="{{ $product->featured }}" class="text-[14.5px]">{{ $product->featured }}</option>
                                <option value="No" class="text-[14.5px]">No</option>
                        ...
                        <div class="mt-5 relative">
                            ...
                            <span class="text-[14.5px] text-[#9CA3AF] absolute top-[58%] left-2">₱</span>
                    ...
                    <div
                        ...
                        <img src="/uploads/products/{{$product->image}}" class="w-full h-[350px] rounded-lg" id="inputImage" alt="No Uploaded Image">
                    </div>
                </div>
