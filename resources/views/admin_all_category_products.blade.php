    ...
    <div class="ms-[250px] bg-[#fefefefe] relative mb-10">
        <div class="px-7 py-5">
            ...
            <div class="flex justify-between items-center mt-10">
                <div>
                    <h1 class="font-semibold"><i class="fa fa-tag"></i> Categories</h1>
                </div>
                ...
                <div class="flex justify-between items-center gap-5">
                    ...
                    <a href="{{route("add_category")}}"
                        class="bg-[#212529] text-white rounded-[20px] py-2 px-4 text-[14.5px]">Add Category</a>
                </div>
            </div>
                            ...
                            @foreach ($categories as $category)
                                <tr class="text-[12px] border-solid border-b-[1px] border-[rgba(0,0,0,0.1)] cursor-pointer">
                                    <td class="font-medium p-2 flex items-center gap-3 w-30">
                                        <img src="uploads/products/{{$category->image}}"
